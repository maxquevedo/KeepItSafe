...
CREATE SEQUENCE  "TEV_TEV_ID1_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  ORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL;
  ...
  CREATE TABLE "VISITAS" 
   ...
   CREATE TABLE FACTURA_MENSUAL(
      "PAGO_MENS_ID" NUMBER PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
   ...
   CREATE TABLE DETALLE_FACTURA(
      "DETALLE_PAGOS_ID" NUMBER PRIMARY KEY,
   ...
   SELECT COUNT(*) INTO V_CAPACITACIONES FROM CAPACITACIONES WHERE CAP_ID_CLI = :NEW.REP_ID_CLI AND cap_fechay ;
